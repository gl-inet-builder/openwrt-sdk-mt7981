...
enum opt_code
{
  ...
  /* OPT_ftail_call_workaround = 1028, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1029,         /* -ftail-call-workaround= */
  ...
  OPT_moverride_ = 1209,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1210,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1211,          /* -msign-return-address= */
  OPT_mstrict_align = 1212,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1213,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1214,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1215,                     /* -mtls-size= */
  OPT_mtune_ = 1216,                         /* -mtune= */
  OPT_muclibc = 1217,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1218,             /* -mverbose-cost-dump */
  OPT_n = 1219,                              /* -n */
  OPT_no_canonical_prefixes = 1220,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1221,              /* -no-integrated-cpp */
  OPT_no_pie = 1222,                         /* -no-pie */
  OPT_nocpp = 1223,                          /* -nocpp */
  OPT_nodefaultlibs = 1224,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1225,                   /* -nostartfiles */
  OPT_nostdinc = 1226,                       /* -nostdinc */
  OPT_nostdinc__ = 1227,                     /* -nostdinc++ */
  OPT_nostdlib = 1228,                       /* -nostdlib */
  OPT_o = 1229,                              /* -o */
  OPT_p = 1230,                              /* -p */
  OPT_pass_exit_codes = 1231,                /* -pass-exit-codes */
  /* OPT_pedantic = 1232, */                 /* -pedantic */
  OPT_pedantic_errors = 1233,                /* -pedantic-errors */
  OPT_pg = 1234,                             /* -pg */
  OPT_pie = 1235,                            /* -pie */
  OPT_pipe = 1236,                           /* -pipe */
  OPT_posix = 1237,                          /* -posix */
  OPT_print_file_name_ = 1238,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1239,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1240,          /* -print-multi-directory */
  OPT_print_multi_lib = 1241,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1242,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1243,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1244,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1245,               /* -print-prog-name= */
  OPT_print_search_dirs = 1246,              /* -print-search-dirs */
  OPT_print_sysroot = 1247,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1248,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1249,                        /* -profile */
  OPT_pthread = 1250,                        /* -pthread */
  OPT_quiet = 1251,                          /* -quiet */
  OPT_r = 1252,                              /* -r */
  OPT_rdynamic = 1253,                       /* -rdynamic */
  OPT_remap = 1254,                          /* -remap */
  OPT_s = 1255,                              /* -s */
  OPT_save_temps = 1256,                     /* -save-temps */
  OPT_save_temps_ = 1257,                    /* -save-temps= */
  OPT_shared = 1258,                         /* -shared */
  OPT_shared_libgcc = 1259,                  /* -shared-libgcc */
  /* OPT_specs = 1260, */                    /* -specs */
  OPT_specs_ = 1261,                         /* -specs= */
  OPT_static = 1262,                         /* -static */
  OPT_static_libasan = 1263,                 /* -static-libasan */
  OPT_static_libgcc = 1264,                  /* -static-libgcc */
  OPT_static_libgfortran = 1265,             /* -static-libgfortran */
  OPT_static_libgo = 1266,                   /* -static-libgo */
  OPT_static_liblsan = 1267,                 /* -static-liblsan */
  OPT_static_libmpx = 1268,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1269,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1270,               /* -static-libstdc++ */
  OPT_static_libtsan = 1271,                 /* -static-libtsan */
  OPT_static_libubsan = 1272,                /* -static-libubsan */
  OPT_static_pie = 1273,                     /* -static-pie */
  /* OPT_std_c__03 = 1274, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1275, */                /* -std=c++0x */
  OPT_std_c__11 = 1276,                      /* -std=c++11 */
  OPT_std_c__14 = 1277,                      /* -std=c++14 */
  OPT_std_c__17 = 1278,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1279, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1280, */                /* -std=c++1z */
  OPT_std_c__2a = 1281,                      /* -std=c++2a */
  OPT_std_c__98 = 1282,                      /* -std=c++98 */
  OPT_std_c11 = 1283,                        /* -std=c11 */
  OPT_std_c17 = 1284,                        /* -std=c17 */
  /* OPT_std_c18 = 1285, */                  /* -std=c18 */
  ...
  OPT_std_f2018 = 1294,                      /* -std=f2018 */
  OPT_std_f95 = 1295,                        /* -std=f95 */
  OPT_std_gnu = 1296,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1297, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1298, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1299,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1300,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1301,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1302, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1303, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1304,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1305,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1306,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1307,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1308, */                /* -std=gnu18 */
  ...
  /* OPT_std_iso9899_2017 = 1319, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1320, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1321,                     /* -std=legacy */
  OPT_symbolic = 1322,                       /* -symbolic */
  OPT_t = 1323,                              /* -t */
  OPT_time = 1324,                           /* -time */
  OPT_time_ = 1325,                          /* -time= */
  OPT_traditional = 1326,                    /* -traditional */
  OPT_traditional_cpp = 1327,                /* -traditional-cpp */
  OPT_trigraphs = 1328,                      /* -trigraphs */
  OPT_u = 1329,                              /* -u */
  OPT_undef = 1330,                          /* -undef */
  OPT_v = 1331,                              /* -v */
  OPT_version = 1332,                        /* -version */
  OPT_w = 1333,                              /* -w */
  OPT_wrapper = 1334,                        /* -wrapper */
  OPT_x = 1335,                              /* -x */
  OPT_z = 1336,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
